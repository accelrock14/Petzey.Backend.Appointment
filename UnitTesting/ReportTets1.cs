...
namespace UnitTesting
{
    ...
    public class ReportTets1
    {
        ...
        [TestMethod]
        public void GetSymptoms_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetAllSymptoms()).Throws(new Exception("Test exception"));
        ...
        [TestMethod]
        public void GetReport_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetReportByID(1)).Throws(new Exception("Test exception"));
        ...
        [TestMethod]
        public void GetTests_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetAllTests()).Throws(new Exception("Test exception"));
        ...
        [TestMethod]
        public void GetMedicine_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetMedicineById(1)).Throws(new Exception("Test exception"));
        ...
        public void GetRecentAppointments_Returns_NotFound_With_InValid_Data()
        {
            ...
            // Assert
            Assert.IsInstanceOfType(actionResult, typeof(OkNegotiatedContentResult<List<AppointmentDetail>>));

        }

        [TestMethod]
        public void GetRecentAppointments_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetRecentAppointmentsByPetID(1)).Throws(new Exception("Test exception"));

            // Act
            IHttpActionResult actionResult = controller.GetRecentAppointments(1);
        ...
        [TestMethod]
        public void GetAllMedicine_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.GetAllMedicines()).Throws(new Exception("Test exception"));
        ...
        [TestMethod]
        public void AddMedicine_Returns_InternalServerError_With_Exception()
        {
            // Arrange
            var prescribedMedicine = new PrescribedMedicine
            {
            ...
            mockDbContext.Setup(db => db.AddMedicineToPrescription(1, prescribedMedicine)).Throws(new Exception("Test exception"));

            // Act
            IHttpActionResult actionResult = controller.AddMedicine(1, prescribedMedicine);
        ...
        [TestMethod]
        public void DeleteMedicine_Returns_InternalServerError_With_Exception()
        {
            // Arrange

            mockDbContext.Setup(db => db.RemoveMedicineFromPrescription(1)).Throws(new Exception("Test exception"));

            // Act
            IHttpActionResult actionResult = controller.DeleteMedicine(1);
        ...
        [TestMethod]
        public void PostReport_Returns_InternalServerError_With_Exception()
        {
            // Arrange
            var report = new Report
            {
                ...
                Tests = new List<ReportTest>(),
                RecommendedDoctors = new List<RecommendedDoctor>(),
                Comment = "Patient is recovering well."
            };

            mockDbContext.Setup(db => db.AddReport(report)).Throws(new Exception("Test exception"));

            // Act
            IHttpActionResult actionResult = controller.PostReport(report);
