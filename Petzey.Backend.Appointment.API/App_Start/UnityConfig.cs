...
namespace Petzey.Backend.Appointment.API
{
    public static class UnityConfig
    {
        public static void RegisterComponents()
        {
            ...
            container.RegisterType<IGraphServiceClientFactory, GraphServiceClientFactory>();
            container.RegisterType<IGraphServiceClient, GraphServiceClientImplementation>();
